...
System.register("angular2-reflow.core", [], function(exports_1) {
    "use strict";
    var CONTEXT, EVENT_BUS;
    return {
        setters:[],
        execute: function() {
            exports_1("CONTEXT", CONTEXT = 'reflow:context');
            exports_1("EVENT_BUS", EVENT_BUS = 'reflow:eventBus');
        }
    }
});
System.register("angular2-reflow", ['angular2/core', 'rxjs', "angular2-reflow.core"], function(exports_2) {
    ...
    return {
        ...
        execute: function() {
            COMMAND_MAP_SETTINGS = '__commandMapSettings__';
            PROVIDER_TOKENS = '__providerTokens__';
            ...
            exports_2("ContextFactory", ContextFactory);
            Context = (function () {
            ...
            SequentialCommandFlow = (function () {
...
//# sourceMappingURL=angular2-reflow.system.js.map